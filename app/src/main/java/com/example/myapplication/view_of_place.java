...
public class view_of_place extends AppCompatActivity {
    ...
    public void view_bag_details(View view) {
        Intent intent = new Intent(view_of_place.this,bag_detail.class);/*Defining The Intent*/
        //intent.putExtra("long","cox");/*Putting The Data To Pass To The Next Activity*/
        //intent.putExtra("khagrachori","khag");/*Putting The Data To Pass To The Next Activity*/
    ...
    public void view_cox_details(View view) {
        Intent intent = new Intent(view_of_place.this,Coxs_places_saved_info.class);/*Defining The Intent*/
        //intent.putExtra("long","cox");/*Putting The Data To Pass To The Next Activity*/
        //intent.putExtra("khagrachori","khag");/*Putting The Data To Pass To The Next Activity*/

        startActivity(intent);/*Starting The Activity*/
    }
    public void view_syl_details(View view) {
        Intent intent = new Intent(view_of_place.this,Syl_detail.class);/*Defining The Intent*/
        //intent.putExtra("long","cox");/*Putting The Data To Pass To The Next Activity*/
        //intent.putExtra("khagrachori","khag");/*Putting The Data To Pass To The Next Activity*/
